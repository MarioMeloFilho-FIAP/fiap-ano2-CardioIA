#!/usr/bin/env python3
"""
Script auxiliar para gerar RELATORIO_PARTE2.pdf a partir do Markdown.
...
class RelatorioPDF(FPDF):
    """PDF customizado para o relatório CardioIA Parte 2."""
    ...
    def header(self):
        ...
        self.cell(0, 5, "CardioIA - Fase 3 - Relatorio Parte 2 (Cloud Computing e Dashboard)", align="C")
        self.ln(8)
    ...
    def table_row(self, cells, header=False):
        ...
        for cell in cells:
            self.cell(col_width, 5, sanitize(cell)[:40], border=1, align="C")
        self.ln()

    def image_placeholder(self, caption):
        """Insere um placeholder para imagem com legenda."""
        self.set_font("Helvetica", "I", 9)
        self.set_fill_color(230, 230, 230)
        self.cell(0, 15, "[Imagem: ver arquivo referenciado]", border=1,
        ...
        # Image references
            ...
            if match:
                ...
                if os.path.exists(abs_img_path):
                    try:
                        pdf.image(abs_img_path, x=15, w=pdf.w - 30)
                        pdf.ln(3)
                    except Exception:
                        pdf.image_placeholder(alt_text)
                else:
                    pdf.image_placeholder(alt_text)
        # Table rows
            ...
            if cells and not all(c.replace("-", "").replace(":", "") == "" for c in cells):
                ...
                pdf.table_row(cells[:5], header=is_header)
...
if __name__ == "__main__":
    ...
    md_file = os.path.join(script_dir, "RELATORIO_PARTE2.md")
    pdf_file = os.path.join(script_dir, "RELATORIO_PARTE2.pdf")
